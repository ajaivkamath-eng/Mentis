...
insert into mentis_holiday_calendar (organization_id, name, kind, starts_on, ends_on) values
  ...
  ('00000000-0000-0000-0000-000000000001', 'February half-term', 'term_holiday_week', '2026-02-16', '2026-02-20'),
  ('00000000-0000-0000-0000-000000000001', 'Easter holidays', 'term_holiday_week', '2026-03-30', '2026-04-10'),
  ('00000000-0000-0000-0000-000000000001', 'May half-term', 'term_holiday_week', '2026-05-25', '2026-05-29'),
  ('00000000-0000-0000-0000-000000000001', 'Summer holidays', 'term_holiday_week', '2026-07-27', '2026-08-28'),
  ('00000000-0000-0000-0000-000000000001', 'October half-term', 'term_holiday_week', '2026-10-26', '2026-10-30'),
  ('00000000-0000-0000-0000-000000000001', 'Christmas holidays', 'term_holiday_week', '2026-12-21', '2027-01-01');
